...
const physicsChapters = d2d.filter((item) => item.subject === 'Physics');
...
export default function PhysicsPage() {
  ...
  const filteredChapters = useMemo(() => {
    let chapters = physicsChapters.filter((chapter) => {
    ...
    <div className="overflow-y-auto bg-white dark:bg-[#181F2A] min-h-screen w-full px-2 py-2 md:px-8 md:py-6 m-0">
      ...
      <div className="hidden md:flex md:items-center md:justify-center md:mb-1 w-full">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-gray-900 dark:text-[#E2E8F0]">Physics PYQs</h1>
        </div>
      </div>
        ...
        >
          <div className="shrink-0">
            <Select value={selectedClass} onValueChange={setSelectedClass}>
              <SelectTrigger className="w-[90px] md:w-[90px] font-medium md:text-[16px] border border-gray-300 dark:border-[#2D3748] dark:bg-[#181F2A] dark:text-[#E2E8F0]">
          ...
          <div className="shrink-0">
            <Select value={selectedUnit} onValueChange={setSelectedUnit}>
              <SelectTrigger className="w-[90px] md:w-[90px] font-[500] md:text-[16px] border border-gray-300  dark:border-[#2D3748] dark:bg-[#181F2A] dark:text-[#E2E8F0]">
          ...
          <Button
            ...
            className="-ml-3 py-1 md:text-[16px] h-auto shrink-0 border border-gray-300  dark:border-[#2D3748] dark:bg-[#181F2A] dark:text-[#E2E8F0]"
            onClick={() =>
      ...
      <div className='flex flex-row justify-between gap-4 pb-4 pt-2 md:mb-2 px-4 md:px-0'>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-44 dark:bg-[#181F2A] dark:text-[#E2E8F0] border border-gray-300 dark:border-[#2D3748]">
            ...
            >
              More Questions in 2025 than 2024
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
                ...
                <div className="flex flex-col gap-1 md:hidden w-full">
                  ...
                  <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-2.5">
                      <span className="font-normal text-base text-gray-900 leading-tight dark:text-[#E2E8F0]">{chapter.chapter}</span>
                    </div>
